...
// Auth information
global.pairNumber = "2349041990122";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["2349041990122", "2349041990122"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["2349041990122", "2349041990122"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["2349041990122"];
global.OwnerName = process.env.OWNER_NAME || "FORMULAR";
global.BotName = process.env.BOT_NAME || "FORMULAR";
global.packname = process.env.PACK_NAME || "FORMULAR Bot";
